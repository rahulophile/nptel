const quizData = [
    ...
    {
        "week": 2,
        "question": "XML is designed to describe ______",
        "options": [
            "pricing",
            "SLA",
            "data",
    ...
    {
        "week": 2,
        "question": "A Cyber-Physical Cloud Computing (CPCC) architectural framework is a ______ environment that can rapidly build, modify and provision cyber-physical systems composed of a set of ______ based sensor, processing, control, and data services.",
        "options": [
    ...
    {
        "week": 2,
        "question": "Network Virtualization is a ______ environment that allows ______ service providers to dynamically compose ______ virtual networks.",
        "options": [
    ...
    {
        "week": 2,
        "question": "Dew Computing is a paradigm where on-premises computers provide functionality that is ______ of cloud services and is also collaborative with cloud services",
        "options": [
            "dependant",
            "independent",
            "partial dependant",
    ...
    },
    {
        ...
        "options": [
            "Cinder, OpenStack | 1. MySQL or NoSQL databases.",
            "GoogleAPIs | 2. Google's fully managed, petabyte scale, low cost analytics data warehouse to find meaningful insights.",
            "Cloud SQL | 3. Integrate Google's services into the application.",
    ...
    {
        "week": 4,
        "question": "Match the following columns regarding OpenStack:",
        "options": [
            "olumn 1 | Column 2"
        ],
        "correctAnswers": []
    ...
    {
        "week": 5,
        "question": "Statement I: In resource management, resource allocation is the allocation of a service provider's resources to a customer Statement II: Resource mapping is correspondence between resources required by the users and resources available with the provider. Which of the options is/are correct?",
        "options": [
    ...
    {
        "week": 5,
        "question": "In a MapReduce framework, the HDFS block size is 64 Mb. We have 3 files of size 65 Kb, 64 Mb and 128 Mb. How many input splits will be created by the Hadoop framework?",
        "options": [
            "2",
            "3",
            "4",
    ...
    {
        "week": 5,
        "question": "The ______ takes a series of key/value pairs, processes each, and generates zero or more output.",
        "options": [
            "map function",
            "partition function",
            "reduce function",
    ...
    {
        "week": 6,
        "question": "Metadata (WSDL) spoofing attack | (c) Introduce malicious code to change the course of execution. | (d) Malicious reengineering of Web Services' metadata description.",
        "options": [
            "1-(a), 2-(b), 3-(d)",
            "1-(c), 2-(a), 3-(d)",
            "1-(b), 2-(c), 3-(d)",
    ...
    {
        "week": 8,
        "question": "Which of the following statements is/are correct? Choose the most appropriate option. Statement 1: An image is a light weight, stand alone, executable package that includes everything to run a piece of software. Statement 2:Container is a run time instance of an image.",
        "options": [
            "Statement 1 is correct but Statement 2 is incorrect",
            "Statement 2 is correct but Statement 1 is incorrect",
            "Both the statements are correct",
    ...
    {
        "week": 8,
        "question": "______ is used to delete a local image.",
        "options": [
            "Docker rm",
            "Docker rmi",
            "Docker rvi",
    ...
    {
        "week": 8,
        "question": "______ enables different networks, spreads in a huge geographical area to connect together and be employed simultaneously by multiple users on demand.",
        "options": [
            "Serverless",
            "IoT Cloud",
            "Sensor Cloud",
    ...
    {
        "week": 8,
        "question": "Virtual machines get virtual access to host resources through a ______",
        "options": [
            "Containers",
            "Hypervisor",
            "Both a and b",
    ...
    {
        "week": 9,
        "question": "In the Cloud-Fog environmental model, servers contain a fog server manager and virtual machines to manage requests by using ______ technique.",
        "options": [
    ...
    {
        "week": 9,
        "question": "______ is a technique in which a server, an application and the associated data are moved onto the edge of the network",
        "options": [
            "Containerization",
            "Virtualization",
            "Offloading",
    ...
    {
        "week": 9,
        "question": "Cloud federation is the collaboration between cloud service providers to achieve which of the following? Choose the most appropriate option(s).",
        "options": [
    ...
    {
        "week": 9,
        "question": "Which of the following correctly describes a classification of resource management architectures in fog/edge computing? Threads of a process share *(Note: Question text seems unrelated to options provided in source)*",
        "options": [
            "Data Flow",
            "Control.",
            "Tenancy.",
    ...
    {
        "week": 10,
        "question": "In Docker utility, ______ is a collection of filesystem layers and some metadata which, if taken together, can be spun up as Docker containers.",
        "options": [
            "Operating System",
            "Microservice",
            "Virtual Machine",
    ...
    {
        "week": 10,
        "question": "Which of the statement(s) is (are) true for containers? Statement-1: Docker is an open platform for automating the deployment, scaling, and management of containerized applications. Statement-2: Containers make it easy to share CPU, memory, storage and network resources at the operating system level.",
        "options": [
            "Only Statement-1 is true",
            "Only Statement-2 is true",
            "Both Statement-1 and 2 are true",
    ...
    {
        "week": 10,
        "question": "In Docker utility, ______ is a collection of filesystem layers and some metadata that, if taken together, can be spun up as Docker containers.",
        "options": [
            "Operating System",
            "Microservice",
            "Virtual Machine",
    ...
    {
        "week": 11,
        "question": "BigQuery is a fully-managed, serverless data warehouse by ______.",
        "options": [
            "AWS",
            "Google",
            "Microsoft",
    ...
    {
        "week": 11,
        "question": "______ are an important distribution mechanism for libraries and custom runtimes in AWS serverless ecosystem.",
        "options": [
            "Runtimes",
            "Lambda Layers",
            "Log streams",
    ...
    {
        "week": 11,
        "question": "(Official Solution - Wk 11, Q 1 Text Missing)",
        "options": [
            "(Option Text Missing)"
        ],
        "correctAnswers": [
    ...
    {
        "week": 11,
        "question": "(Official Solution - Wk 11, Q 2 Text Missing)",
        "options": [
            "(Option Text Missing)"
        ],
        "correctAnswers": [
    ...
    {
        "week": 11,
        "question": "(Official Solution - Wk 11, Q 3 Text Missing)",
        "options": [
            "(Option Text Missing)"
        ],
        "correctAnswers": [
    ...
    {
        "week": 11,
        "question": "(Official Solution - Wk 11, Q 4 Text Missing)",
        "options": [
            "(Option Text Missing)"
        ],
        "correctAnswers": [
    ...
    {
        "week": 11,
        "question": "(Official Solution - Wk 11, Q 5 Text Missing)",
        "options": [
            "(Option Text Missing)"
        ],
        "correctAnswers": [
    ...
    {
        "week": 11,
        "question": "(Official Solution - Wk 11, Q 6 Text Missing)",
        "options": [
            "(Option Text Missing)"
        ],
        "correctAnswers": [
    ...
    {
        "week": 11,
        "question": "(Official Solution - Wk 11, Q 7 Text Missing)",
        "options": [
            "(Option Text Missing)"
        ],
        "correctAnswers": [
    ...
    {
        "week": 11,
        "question": "(Official Solution - Wk 11, Q 8 Text Missing)",
        "options": [
            "(Option Text Missing)"
        ],
        "correctAnswers": [
    ...
    {
        "week": 11,
        "question": "(Official Solution - Wk 11, Q 9 Text Missing)",
        "options": [
            "(Option Text Missing)"
        ],
        "correctAnswers": [
    ...
    {
        "week": 11,
        "question": "(Official Solution - Wk 11, Q 10 Text Missing)",
        "options": [
            "(Option Text Missing)"
        ],
        "correctAnswers": [
    ...
    {
        "week": 12,
        "question": "Cyber-physical system is all about ______ of the physical and the cyber.",
        "options": [
            "Union",
            "Intersection",
            "Segregation",
    ...
    {
        "week": 12,
        "question": "A______ is a trace generated by a moving object in geographical space, usually represented by a series of chronologically ordered points.",
        "options": [
            "Time series",
            "Road map",
            "Spatial trajectory",
    ...
    {
        "week": 12,
        "question": "Dew computing is an on premises computer software-hardware organization paradigm where on-premises computers provide functionality that is ______ of cloud services and is also ______ with cloud services.",
        "options": [
    ...
    {
        "week": 12,
        "question": "The key aspect of the intelligent transportation system is efficient ______",
        "options": [
            "cost",
            "mobility",
            "speed",
...
function generateWeekTabs() {
    ...
    const weeks = [...new Set(quizData.map(q => q.week).filter(w => w !== undefined && w !== null))]
...
function highlightActiveTab() {
    ...
    if (weekToHighlight === null || weekToHighlight === 'All') {
         if (quizData.length > 0 && currentQuestionIndex < quizData.length) {
             ...
             weekToHighlight = quizData[currentQuestionIndex].week !== undefined ? quizData[currentQuestionIndex].week : 'All';
         } else {
...
function loadQuestion() {
    ...
    if (!currentQuestion || typeof currentQuestion.question !== 'string' || !Array.isArray(currentQuestion.options) || !Array.isArray(currentQuestion.correctAnswers)) {
         console.error("Incomplete data for question index:", currentQuestionIndex, currentQuestion);
         questionTextEl.textContent = "Error loading question data at index " + currentQuestionIndex;
         optionsContainerEl.innerHTML = '';
         sourceIndicatorEl.textContent = "";
    ...
    sourceIndicatorEl.textContent = `Source: ${currentQuestion.source || 'N/A'} - Week ${currentQuestion.week !== undefined ? currentQuestion.week : 'N/A'}`;
...
function selectAnswer(selectedOptionElement, selectedIndex) {
    ...
    if (isCorrect) {
        ...
        if (!selectedOptionElement.querySelector('strong')) { // Avoid double bolding
...
function nextQuestion() {
    if (currentQuestionIndex < quizData.length - 1) {
        ...
        if (currentWeekFilter !== 'All' && currentWeekFilter !== null && newQuestionWeek !== currentWeekFilter) {
